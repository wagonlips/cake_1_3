...
<tr> 
  ...
  <th><?php echo $paginator->sort('Date', 'Timecard.entry_date'); ?></th> 
  <th><?php echo $paginator->sort('Time In', 'Timecard.entry_time_in'); ?></th> 
  <th><?php echo $paginator->sort('Time Out', 'Timecard.entry_time_out'); ?></th> 
  <th><?php echo $paginator->sort('Job', 'Timecard.entry_job'); ?></th> 
  <th>Actions</th> 
</tr> 
<?php foreach ($timecards as $timecard): ?>
<tr>
  <td> <?php echo $timecard['Timecard']['id']; ?> </td>
  <td> <?php echo $timecard['Timecard']['entry_date']; ?> </td>
  <td><?php echo $timecard['Timecard']['entry_time_in']; ?></td>
  <td><?php echo $timecard['Timecard']['entry_time_out']; ?></td>
  <td><?php echo $timecard['Timecard']['entry_job']; ?></td>
  <td>
